...
// These 3 blocks of code are used to rotate the faces of the cube which allows the colors to follow the rotation
...
// This block of code ensures that the cube created within the 3D space is oriented correctly into a cube
// And not overlapping the other faces.
  void show() {
    pushMatrix();
    fill(c);
    noStroke();
